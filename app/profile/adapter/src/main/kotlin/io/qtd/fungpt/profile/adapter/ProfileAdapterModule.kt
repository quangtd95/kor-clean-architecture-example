...
import io.qtd.fungpt.profile.adapter.events.UserCreatedEventsSubscriber
import io.qtd.fungpt.profile.adapter.events.UserDeletedEventsSubscriber
...
class ProfileAdapterModuleCreation : KoinComponent, AdapterModuleCreation() {
    ...
    override fun getEventSubscriber(): List<EventSubscriber> {
        return listOf(
            get<UserCreatedEventsSubscriber>(),
